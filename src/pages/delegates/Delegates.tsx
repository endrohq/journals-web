...
import { DelegatesItem } from 'src/pages/delegates/DelegatesItem';
...
const Delegates: React.FC<ContainerProps> = () => {
  ...
  const [response, setResponse] = useState<ApiResponse<LiskAccount[]>>(undefined);
  ...
  return (
    <div className="grid mt50 mb200">
      ...
      <div className="br5 br">
        <div className="flex-c bgc-white p15-25 br5-top ffm-bold fc-black br-b">
          <div className="w10">
            Rank
          </div>
          <div className="w20">
